	...
	THREE.TransformControls = function ( camera, domElement ) {
		...
		function onPointerMove( event ) {
			...
			if ( _mode == "translate" ) {
				...
				var LatLng_correctedXYZ = xyz_to_LatLng_correctedXYZ(scope.object.position);
				if(LatLng_correctedXYZ !== undefined)
				{
					scope.object.position.x = LatLng_correctedXYZ.x_with_depth;
					scope.object.position.y = LatLng_correctedXYZ.y_with_depth;
					scope.object.position.z = LatLng_correctedXYZ.z_with_depth;
				}
				//update the positon to the right depth
