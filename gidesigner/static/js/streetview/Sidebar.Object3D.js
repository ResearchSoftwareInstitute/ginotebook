...
//	container.add( objectUserDataRow );
	...
	function update() {
		...
		if ( object !== null ) {
			...
			var LatLng_correctedXYZ = xyz_to_LatLng_correctedXYZ(
			{x:objectPositionX.getValue(), y:objectPositionY.getValue(), z:objectPositionZ.getValue()}
			);//at this point the depth map should be already available. no callback and asynchronous issues.
			object.position.x = LatLng_correctedXYZ.x_with_depth;
			object.position.y = LatLng_correctedXYZ.y_with_depth;
			object.position.z = LatLng_correctedXYZ.z_with_depth;
