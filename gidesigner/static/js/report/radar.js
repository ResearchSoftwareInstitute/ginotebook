  ...
  draw: function(id, data, options) {
    ...
    function buildAxesLabels() {
      vis.axes
        ...
        .attr("x", function(d, i) { return config.w / 2 * (0.95 - 1.3 * Math.sin(i * config.radians / vis.totalAxes)); })
        .attr("y", function(d, i) { return config.h / 2 * (1 - 1.2 * Math.cos(i * config.radians / vis.totalAxes)); })
        .attr("font-family", "sans-serif")
        .attr("font-size", "15px");
